...
class DishDetail extends Component{
    ...
    renderComments({comments,addComment, dishId}) {
       if ({comments} != null) {
        let commentf=this.CommentForm(dishId={dishId}, addComment={addComment});
        const commentItem = this.props.comments.map((comment) => {
            return ( 
               <div>            
    ...
    render () {
          let commentItem;
          commentItem = this.renderComments(this.props.comments, this.props.addComment, this.props.dish.id);
          let dishItem;
